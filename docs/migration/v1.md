...
-   No type or runtime behavior changes outside the deletions.
...
Then add a `.dark`-class toggle around the editor tree.
...
New code should prefer the semantic surface directly. The `--editor-color-*` aliases are scheduled for removal in v2.0.
...
No exported APIs were removed in v1.0.
