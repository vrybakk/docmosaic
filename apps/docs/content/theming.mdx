---
title: Theming
description: The --editor-* CSS variable surface and the base / brand-theme split. Rebrand with a single variable, or ship your own theme on top of the shared structural base.
---
