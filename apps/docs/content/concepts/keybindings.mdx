---
title: Keybindings
description: The built-in keyboard layer — undo/redo, nudge, delete, deselect. Fully overridable.
---
...
Nudge values are in points — see [Unit system](/docs/concepts/unit-system) for why.
...
- [Designer](/docs/concepts/designer) — selection model that nudge / delete operate on
- [Layers](/docs/concepts/layers) — z-index actions that could be bound to shortcuts in the future
