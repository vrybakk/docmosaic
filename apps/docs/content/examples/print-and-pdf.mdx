...
<Callout type="info">
    All geometry is stored in **PDF points (72 DPI)**, not CSS pixels. The download is byte-identical between dev and prod because the document model carries pre-converted coordinates. See [Unit system](/docs/concepts/unit-system).
</Callout>
