...
New code should prefer the semantic surface directly — `var(--primary)` instead of `var(--editor-color-accent)`, and so on. The `--editor-color-*` aliases are scheduled for removal in v2.0.
